...
AProjectSuckerGunCharacter::AProjectSuckerGunCharacter()
{
...
void AProjectSuckerGunCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AProjectSuckerGunCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AProjectSuckerGunCharacter::Move);
...
void AProjectSuckerGunCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AProjectSuckerGunCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
